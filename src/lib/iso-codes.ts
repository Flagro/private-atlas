 ...
 * Used to correlate world-atlas topojson feature IDs (numeric) with
 * the alpha-2 country codes stored in the database.
 */
export const NUMERIC_TO_ALPHA2: Record<number, string> = {
  4: "AF", 8: "AL", 12: "DZ", 16: "AS", 20: "AD", 24: "AO", 28: "AG",
  32: "AR", 36: "AU", 40: "AT", 44: "BS", 48: "BH", 50: "BD", 52: "BB",
  ...
  233: "EE", 238: "FK", 242: "FJ", 246: "FI", 250: "FR", 258: "PF",
  262: "DJ", 266: "GA", 268: "GE", 276: "DE", 288: "GH", 292: "GI",
  296: "KI", 300: "GR", 304: "GL", 308: "GD", 316: "GU", 320: "GT",
  ...
  466: "ML", 470: "MT", 478: "MR", 484: "MX", 492: "MC", 496: "MN",
  498: "MD", 499: "ME", 504: "MA", 508: "MZ", 516: "NA", 524: "NP",
  528: "NL", 540: "NC", 554: "NZ", 558: "NI", 562: "NE", 566: "NG",
  578: "NO", 583: "FM", 585: "PW", 586: "PK", 591: "PA", 598: "PG",
  600: "PY", 604: "PE", 608: "PH", 616: "PL", 620: "PT", 630: "PR",
  634: "QA", 642: "RO", 643: "RU", 646: "RW", 659: "KN", 662: "LC",
  670: "VC", 678: "ST", 682: "SA", 686: "SN", 688: "RS", 694: "SL",
...
export function numericToAlpha2(id: number | string): string | undefined {
  return NUMERIC_TO_ALPHA2[Number(id)];
}
